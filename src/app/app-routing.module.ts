...
const routes: Routes = [
  ...
  { path: 'order-tracking-operation/:id', component: OrderTrackingOperationComponent, canActivate: [AuthGuard]},
  { path: 'device-delivery-list', component: DeviceDeliveryListComponent, canActivate: [AuthGuard]},
  { path: 'device-delivery-operation/:id', component: DeviceDeliveryOperationComponent, canActivate: [AuthGuard]},
